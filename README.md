...
## Fonctionnalités
- Grille de pronos : champion, finaliste, meilleur buteur, parcours des Bleus, révélation, score France–Sénégal, total de buts.
- Classement automatique avec barème (20/12/10/8/6…), podium 🥇🥈🥉, départage au total de buts.
- Espace **organisateur** protégé par code : saisie des résultats, verrouillage des pronos, réinitialisation.
- Stockage partagé : tout le monde voit le même classement en temps réel.
